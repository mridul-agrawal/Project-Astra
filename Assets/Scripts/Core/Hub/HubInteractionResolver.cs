...
namespace ProjectAstra.Core.Hub
{
    ...
    public readonly struct HubInteractionCandidate
    {
        public readonly string Id;
        public readonly HubTargetKind Kind;
        public readonly Vector2 FootPosition;
        public readonly HubVerb Verb;

        public HubInteractionCandidate(string id, HubTargetKind kind, Vector2 footPosition, HubVerb verb)
        {
            Id = id;
            Kind = kind;
    ...
    public static class HubInteractionResolver
    {
        ...
        public static bool TryResolve(Vector2 playerFoot, Facing facing,
            IReadOnlyList<HubInteractionCandidate> candidates, HubCollisionMap collision,
            out HubInteractionCandidate chosen,
            float reach = DefaultReachTiles, float lateralTolerance = DefaultLateralTolerance)
        {
            ...
            foreach (HubInteractionCandidate candidate in candidates)
            {
        ...
        private static bool Beats(HubTargetKind kind, float lateral, float forward,
            HubTargetKind bestKind, float bestLateral, float bestForward)
        {
        ...
        private static bool HasLineOfSight(Vector2 from, Vector2 to, HubCollisionMap collision)
        {
