...
namespace ProjectAstra.Core.UI.Progression
{
    ...
    {
        [Header("Motion")]
        [SerializeField] private float floatUpSeconds = 1.2f;
        ...
        [SerializeField] private Color textColor = new Color(0.486f, 0.827f, 0.416f, 1f);
        ...
        {
            if (amount <= 0) return;
            StartCoroutine(PlayFloat(worldPos + spawnOffset, amount));
        }
