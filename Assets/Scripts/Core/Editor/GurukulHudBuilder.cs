...
namespace ProjectAstra.Core.Editor
{
    ...
    public static class GurukulHudBuilder
    {
        ...
        public static GurukulHUDController Build(out ChoiceMenuView choiceMenu, out EdgeIndicatorView edgeIndicators)
        {
            GameObject canvasGo = CreateCanvas();
            InteractionPromptView prompt = CreateInteractionPrompt(canvasGo.transform);
            GurukulObjectiveView objective = CreateObjectivePanel(canvasGo.transform);
            choiceMenu = CreateChoiceMenu(canvasGo.transform);
            edgeIndicators = CreateEdgeIndicators(canvasGo.transform);

            var controller = canvasGo.AddComponent<GurukulHUDController>();
        ...
        private static GurukulObjectiveView CreateObjectivePanel(Transform parent)
        {
            ...
            var view = root.AddComponent<GurukulObjectiveView>();
        ...
        private static void AddCompletionCue(Transform parent, GurukulObjectiveView view)
        {
        ...
        {
            var go = new GameObject("GurukulHUD", typeof(Canvas), typeof(CanvasScaler), typeof(GraphicRaycaster));
