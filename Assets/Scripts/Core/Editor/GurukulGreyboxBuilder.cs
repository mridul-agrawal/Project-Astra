...
{
    // Makes a programmer-art Gurukul to build against: a courtyard wider than the screen, walls to
    ...
    public static class GurukulGreyboxBuilder
    {
        ...
        [MenuItem("Project Astra/Gurukul/Build Greybox Location")]
        public static void Build()
        {
            ...
            Debug.Log($"[GurukulGreybox] Built the courtyard, a house to go inside, props and visit '{visit.VisitId}'.");
        }
        ...
        {
            var interactable = treeGo.AddComponent<GurukulInteractable>();
            var serialized = new SerializedObject(interactable);
            serialized.FindProperty("interactableId").stringValue = "greybox_tree";
            serialized.FindProperty("kind").enumValueIndex = (int)GurukulTargetKind.Inspectable;
            serialized.FindProperty("verb").enumValueIndex = (int)GurukulVerb.Inspect;
        ...
        private static void WriteCourtyardDoor(SerializedProperty doors)
        {
            ...
            door.FindPropertyRelative("verb").enumValueIndex = (int)GurukulVerb.Enter;
        ...
        private static void WriteHouseExit(SerializedProperty doors)
        {
            ...
            door.FindPropertyRelative("verb").enumValueIndex = (int)GurukulVerb.Leave;
        ...
        private static void BuildEvents()
        {
            ...
            serialized.FindProperty("trigger").enumValueIndex = (int)GurukulEventTrigger.VisitLoad;
            ...
            walk.FindPropertyRelative("kind").enumValueIndex = (int)GurukulEventActionKind.WalkCharacter;
