...
namespace ProjectAstra.Core.Gurukul
{
    ...
    public static class GurukulMover
    {
        ...
        private const float MaxSubStep = GurukulCollisionMap.CellSize * 0.5f;
        ...
        public static Vector2 Move(GurukulCollisionMap map, Vector2 position, Rect footprintOffset,
        ...
        private static Vector2 SweepAxis(GurukulCollisionMap map, Vector2 position, Rect offset, Vector2 axisDelta)
        {
        ...
        // still clear.
        private static Vector2 SnugUpTo(GurukulCollisionMap map, Vector2 from, Rect offset, Vector2 step, float length)
        {
            float safe = 0f;
