...
namespace ProjectAstra.Core.Gurukul
{
    ...
    public enum GurukulConditionKind
    {
    ...
    [Serializable]
    public class GurukulCondition
    {
        public GurukulConditionKind kind;
        ...
        public int RequiredCount => kind == GurukulConditionKind.Immediate ? 0 : TargetCount;

        private int TargetCount => targetIds != null ? targetIds.Length : 0;

        public bool Accepts(GurukulConditionKind reportedKind, string targetId)
        {
