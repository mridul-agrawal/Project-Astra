...
namespace ProjectAstra.EditorTools
{
    ...
    // Assets/UI/InventoryPopup/ so Figma exports drop in ready-to-use.
    public class InventoryPopupImporter : AssetPostprocessor
    {
        const string RootPath = "Assets/UI/InventoryPopup/";
